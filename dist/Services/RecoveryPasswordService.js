...
var RecoveryPasswordService = /** @class */ (function () {
    function RecoveryPasswordService() {
    }
    RecoveryPasswordService.prototype.execute = function (_a) {
        var password = _a.password, id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, userExists, hash_password, user;
